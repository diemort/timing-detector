...
ctppsDiamondGeomXMLFiles = cms.vstring(
    ...
    'Geometry/VeryForwardData/data/CTPPS_Diamond_2018/2021/v1/CTPPS_Diamond_Detector_Assembly.xml'
    )

XMLIdealGeometryESSource = cms.ESSource("XMLIdealGeometryESSource",
    geomXMLFiles = totemGeomXMLFiles + ctppsDiamondGeomXMLFiles,
#    rootNodeName = cms.string('cms:OCMS')
    rootNodeName = cms.string('CTPPS_Timing_Positive_Station:CTPPS_Timing_Positive_Station')
    )
